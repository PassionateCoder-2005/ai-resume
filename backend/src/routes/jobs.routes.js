...
import { createJobs, getAllJobs,getJobAllDetails ,getOneJobDetails,deleteJob, recommendJobs, getAllJobCreatedByHr} from "../controller/jobs.controller.js"
...
jobsRouter.get("/all-jobs/hr",isLoggedIn,checkHrRole,getAllJobCreatedByHr)
